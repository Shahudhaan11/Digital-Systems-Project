...
| **Favourites**             | Save movies with a tap; they live on their own tab and persist between sessions.         |
| **Seat booking**           | Pick a date (next 7 days), a showtime, and seats from an interactive grid.               |
