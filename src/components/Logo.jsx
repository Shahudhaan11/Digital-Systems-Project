...
export function LogoMark({ size = 40 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      <Defs>
        <LinearGradient id="seatflickGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <Stop offset="0%" stopColor="#ffb64d" />
          <Stop offset="100%" stopColor="#ff9800" />
        </LinearGradient>
      </Defs>
      <Ellipse cx="100" cy="70" rx="50" ry="30" fill="url(#seatflickGrad)" opacity={0.9} />
      <Path d="M 60 100 Q 60 130 100 135 Q 140 130 140 100 Z" fill="url(#seatflickGrad)" />
      <G opacity={0.85}>
